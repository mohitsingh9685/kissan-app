      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            getLabel("Categories"),
            SizedBox(height: 15),
            OptionItem(text: "Seasonal"),
            SizedBox(height: 15),
            OptionItem(text: "Fresh"),
            SizedBox(height: 15),
            OptionItem(text: "Frozen"),
            SizedBox(height: 15),
            OptionItem(text: "Stored"),
            SizedBox(height: 30),
            getLabel("Types"),
            SizedBox(height: 15),
            OptionItem(text: "Hybrid"),
            SizedBox(height: 15),
            OptionItem(text: "Organically"),
            SizedBox(height: 15),
            OptionItem(text: "Desi"),
            SizedBox(height: 15),
            OptionItem(text: "imported"),
            Spacer(),
            AppButton(
              label: "Apply Filter",
